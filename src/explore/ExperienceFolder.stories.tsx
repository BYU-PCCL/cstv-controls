...
export const ExperienceFolders: ComponentStory<typeof ExperienceFoldersComponent> = (
    args
) => (
    <PageWidth>
        <ExperienceFoldersComponent {...args} folders={testExperienceFolders} onExperienceClick={ () => null} />
    </PageWidth>
);
